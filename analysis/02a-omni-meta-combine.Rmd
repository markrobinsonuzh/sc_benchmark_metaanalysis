...
saveRDS(answers_agg, file="answers_agg.rds")
saveRDS(numeric_cols, file="numeric_cols.rds")
saveRDS(categ_cols, file="categ_cols.rds")
saveRDS(union_cols, file="union_cols.rds")
